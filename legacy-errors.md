...
Below you will find details for our various response codes for our [legacy API](https://plaid.com/docs/legacy/api).
...
`401` | `1106` | *bad public_token* | This public_token is corrupt or does not exist in our database. See the [Link docs](https://plaid.com/docs/legacy/quickstart/).
`401` | `1107` | *missing public_token* | Include the public_token received from the Plaid Link module. See the [Link docs](https://plaid.com/docs/legacy/quickstart/).
`401` | `1108` | *invalid type* | This institution is not currently supported.
`401` | `1109` | *unauthorized product* | The sandbox client_id and secret can only be used with sandbox credentials and access tokens. See the [Sandbox docs](https://plaid.com/docs/legacy/api#sandbox).

**Note:** This repository is not Plaid's primary support channel. If your issue is time-sensitive or relates to a specific API `access_token`, please email support@plaid.com.
